...
ko.jsonExpressionRewriting = (function () {
    ...
    return {
        ...
        parseObjectLiteral: function(objectLiteralString) {
            ...
            // that is sufficient just to split an object literal string into a set of top-level key-value pNewgen
            ...
            // Now we can safely split on commas to get the key/value pNewgen
            var result = [];
            var keyValuePNewgen = str.split(",");
            for (var i = 0, j = keyValuePNewgen.length; i < j; i++) {
                var pair = keyValuePNewgen[i];
